...
const hotelEdit=async(req,res,next)=>{
    ...
    try{
        const HoteltoUpdate=await  HotelModel.findByIdAndUpdate(req.params.id,{$set:req.body},{new:true})
...
module.exports={hotelCreate,hotelEdit,hotelDelete,getAllHotel,getSingleHotel}